...
You can configure the `optionalResultSetMetadata` option to control whether it's possible to enable/disable resultset metadata transfer using system variable `resultset_metadata`.
